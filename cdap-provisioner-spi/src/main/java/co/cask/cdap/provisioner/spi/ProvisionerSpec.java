 ...
 */
public class ProvisionerSpec {
  private final String name;
  private final String label;
  private final String description;
  private final Map<String, ProvisionerProperty> properties;

  public ProvisionerSpec(String name, String label, String description, Map<String, ProvisionerProperty> properties) {
    this.name = name;
    this.label = label;
  ...
  public boolean equals(Object o) {
    ...
    ProvisionerSpec that = (ProvisionerSpec) o;
